module Toyclone
  ...
  module ResultBuilder
    def self.build(indexed : IndexedRows, result : KernelResult) : Array(OutputRow)
      ...
      prevalence = result.cluster_sample_prevalence
      prevalence_std = result.cluster_sample_prevalence_std
      ...
      indexed.mutation_ids.each_with_index do |mutation_id, m_i|
        ...
        cluster_offset = cluster_id * sample_count
        ...
        indexed.sample_ids.each_with_index do |sample_id, s_i|
          rows << OutputRow.new(
            ...
            cellular_prevalence: prevalence[cluster_offset + s_i],
            cellular_prevalence_std: prevalence_std[cluster_offset + s_i],
